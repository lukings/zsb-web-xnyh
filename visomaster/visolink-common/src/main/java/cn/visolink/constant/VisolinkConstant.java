...
public class VisolinkConstant {
     ...
     * redis 系统(来源)
     */
    public static final String REDIS_KEY = "VISO";

    public static final String TOKEN_KEY = "TokenKey";

    public static final String OUTBOUND_JOB = "outbound.CommonJobID.";
    public static final String OUTBOUND_org = "outbound.JobOrgID.";
}
