...
public class ProjectCluesForm extends Page {
    ...
    @ApiModelProperty(value = "重分配人的id")
    ...
    @ApiModelProperty(value = "意向集合")
    private List<String> levelList;

    @ApiModelProperty(value = "成交类型集合")
    private List<String> sourceTypeList;

    @ApiModelProperty(value = "案场意向等级集合")
    private List<String> tradeLevelList;

    @ApiModelProperty(value = "是否联名客户集合")
    private List<String> isRepurchaseList;

    @ApiModelProperty(value = "线索集合")
    private List<String> redistributionIdList;

    @ApiModelProperty(value = "认知途径集合")
    private List<String> mainMediaList;

    @ApiModelProperty(value = "经纪人身份集合")
    private List<String> brokerList;

    @ApiModelProperty(value = "是否关联客户集合")
    private List<String> relatedList;

    @ApiModelProperty(value = "是否旭客家自动报备")
    private List<String> isReportList;

    @ApiModelProperty(value = "客户有效性")
    private List<String> clueValidityList;

    @ApiModelProperty(value = "是否二级经纪人")
    private String isSecondBroker;
