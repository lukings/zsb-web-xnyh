...
public class CompanyInfoController {
    ...
    public Integer addCompanyInfo(@RequestBody(required = false) Map map,HttpServletRequest request) {
    ...
    public Map getCompanyInfoAll(@RequestBody Map map, HttpServletRequest request) {
        String authCompanyId = request.getHeader("AuthCompanyID");
    ...
    @RequestMapping(value = "/queryAssInforData", method = RequestMethod.POST)
    ...
    public Integer updateCompanyStatus(@RequestBody Map paramMap) {
        int result = companyService.updateCompanyStatus(paramMap);
        return result;
    }
    ...
    @Log("中介导出")
    @CessBody
    @ApiOperation(value = "中介导出", notes = "中介导出")
    @PostMapping(value = "/companyExport")
    public void companyExport(HttpServletRequest request, HttpServletResponse response, @RequestBody String param) {
        companyService.companyExport(request,response, param);
    }
}
