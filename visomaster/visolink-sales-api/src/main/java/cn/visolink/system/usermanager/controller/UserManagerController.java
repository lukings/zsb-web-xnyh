...
public class UserManagerController {
    ...
    public Map getUserMessage(@RequestBody Map map, HttpServletRequest request) {
    ...
    public int deleteUsers(@RequestBody Map map,HttpServletRequest request) {
    ...
    public int execute(@RequestBody Map map,HttpServletRequest request){
        map.put("username",request.getHeader("username"));
    ...
    @GetMapping("getSynStatus")
    public Map getSynStatus(){
        return userMessageService.getSynStatus();
