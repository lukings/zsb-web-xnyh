...
//        Connection connection = ConnectionManagerXZS.getInstance().getConnection();
        try{
            String sql = "";
    ...
    public static Map<String,Object> getObject(String tableName,String wheres,String whereValue){
        ...
        try{
            String sql = "";
            sql = "select * from "+tableName+" where "+wheres+" = '"+whereValue+"'";
...
//            re = new QueryRunner().update(connection,sql);
     ...
     * 更新表数据方法
     */
    public static int updateObject(String sql){
        int re = 0;
        Connection connection = ConnectionManagerXZS.getInstance().getConnection();
        try{
            re = new QueryRunner().update(connection,sql);
